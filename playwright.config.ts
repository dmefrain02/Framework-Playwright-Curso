...
/*
Para ejecutar con ternario:
set NODE_ENV=dev // Asignar variable del ambiente
echo %NODE_ENV% //Validar variable
npx playwright test tests/saucedemo.spec.ts //Ejecutar pruebas
*/
require('dotenv').config(
  {
    path: `.env.${process.env.NODO_ENV ? process.env.NODE_ENV:'dev'}`
